...
public class Menú extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImageIcon icono=new ImageIcon(getClass().getResource("/Imagenes/Escritorio.jpg"));
        ...
        jMenuItem1.setText("Agregar y eliminar rutas");
        ...
        jMenuItem5.setText("Buscar rutas");
        ...
        jMenuItem2.setText("Gestionar horarios");
        ...
        jMenuItem4.setText("Gestionar pasajes");
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        escritorio.removeAll();
        escritorio.repaint();
        GestionRutas2 gr=new GestionRutas2();
        escritorio.add(gr);
        gr.setVisible(true);
        escritorio.moveToFront(gr);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        escritorio.removeAll();
       escritorio.repaint();
       GestionPasajes gp=new GestionPasajes();
       escritorio.add(gp);
       gp.setVisible(true);
       escritorio.moveToFront(gp);
